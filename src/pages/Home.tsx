import ProfilePhoto from "../assets/IMG_4133.png";

function Home() {
  return (
    <div className="w-full flex justify-center items-center gap-4">
      <div className="flex flex-col text-[#2F4156] gap-4">
        <svg
        ...
        <h1 className="text-8xl font-vanilla-ravioli">
          Hello everyone, I'm Kaylie Rim
        </h1>
        <p className="font-poppins text-xl">
          I am a computer science student with a minor in French at Northeastern
          University. Nice to meet you!
        </p>
      </div>
      <img src={ProfilePhoto} className="h-[500px]" />
    </div>
  );
}
